...
#define SCRIPT_FUNC_H
    ...
    #define MTR_SF_GET_UINT8(varname, stackpos)      varname = (uint8_t)lua_tounsigned(mtrVm, stackpos)
    #define MTR_SF_GET_UINT32(varname, stackpos)     varname = (uint32_t)lua_tounsigned(mtrVm, stackpos)
