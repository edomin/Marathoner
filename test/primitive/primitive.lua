...
for i = 0, 60, 1 do
    ...
    PrimitiveRectangle_rgba_f(32 + i * 2, 64, 32 + i * 2 + 24, 88, 0xFF, 0x00,
     0x00, 0xFF);
    PrimitiveRectangle_c_f(32 + i * 2, 32, 96 + i * 2 + 24, 120, 0xFF0000);
    PrimitiveRectangle_ca_f(32 + i * 2, 32, 128 + i * 2 + 24, 152, 0xFF0000FF);
    ScreenFlip();
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    PrimitiveRectangleFilled_rgba_f(32 + i * 2, 64, 32 + i * 2 + 24, 88, 0xFF,
     0x00, 0x00, 0xFF);
    PrimitiveRectangleFilled_c_f(32 + i * 2, 32, 96 + i * 2 + 24, 120,
     0xFF0000);
    PrimitiveRectangleFilled_ca_f(32 + i * 2, 32, 128 + i * 2 + 24, 152,
     0xFF0000FF);
    ScreenFlip();
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    PrimitiveRoundedRectangle_c_f(32 + i * 2, 32, 96 + i * 2 + 24, 120,
     i / 60 * 10, 0xFF0000);
    PrimitiveRoundedRectangle_ca_f(32 + i * 2, 32, 128 + i * 2 + 24, 152,
     i / 60 * 10, 0xFF0000FF);
    ScreenFlip();
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    PrimitiveRoundedRectangleFilled_rgba_f(32 + i * 2, 64, 32 + i * 2 + 24, 88,
     i / 60 * 10, 0xFF, 0x00, 0x00, 0xFF);
    PrimitiveRoundedRectangleFilled_c_f(32 + i * 2, 32, 96 + i * 2 + 24, 120,
     i / 60 * 10, 0xFF0000);
    PrimitiveRoundedRectangleFilled_ca_f(32 + i * 2, 32, 128 + i * 2 + 24, 152,
     i / 60 * 10, 0xFF0000FF);
    ScreenFlip();
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    PrimitiveLineTo_rgba_f(64 + i, 64, 0x00, 0xFF, 0x00, 0x00);
