...
for i = 0, 60, 1 do
    ...
    x = x + 2;
    PrimitiveFill_c(0x000000);
    TextureBlitRegion_f(helicopterAnim, x, 128, Floor_f(i / 4) % 8, 0, 96, 32);
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    TextureBlitRegionScaled_f(helicopterAnim, x, 128, (162 - x) / 162 * 96,
     (162 - x) / 162 * 32, Floor_f(i / 4) % 8, 0, 96, 32);
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    x = x + 2;
    PrimitiveFill_c(0x000000);
    TextureBlitRegionAngled_f(helicopterAnim, x, 128, Floor_f(i / 4) % 8, 0, 96,
     32, -x, 48, 16);
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    x = x + 2;
    PrimitiveFill_c(0x000000);
    TextureBlitRegionFlipped_f(helicopterAnim, x, 128, Floor_f(i / 4) % 8, 0,
     96, 32, FLIP_NONE);
    TextureBlitRegionFlipped_f(helicopterAnim, x, 160, Floor_f(i / 4) % 8, 0,
     96, 32, FLIP_HORIZONTAL);
    TextureBlitRegionFlipped_f(helicopterAnim, x, 192, Floor_f(i / 4) % 8, 0,
     96, 32, FLIP_VERTICAL);
    TextureBlitRegionFlipped_f(helicopterAnim, x, 224, Floor_f(i / 4) % 8, 0,
     96, 32, FLIP_BOTH);
    TimerDelayForFPS(30);
end;
...
for i = 0, 60, 1 do
    ...
    TextureBlitRegionGeneral_f(helicopterAnim, x, 128, (162 - x) / 162 * 96,
     (162 - x) / 162 * 32, Floor_f(i / 4) % 8, 0, 96, 32, -x, 48, 16,
     FLIP_NONE);
