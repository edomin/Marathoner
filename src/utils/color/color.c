...
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorAssembleRGB(uint8_t r, uint8_t g,
 uint8_t b)
{
...
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorAssembleRGBA(uint8_t r, uint8_t g,
 uint8_t b, uint8_t a)
{
...
MTR_DCLSPC void MTR_CALL MTR_ColorSplitRGB(uint32_t rgb, uint8_t *r, uint8_t *g,
 uint8_t *b)
{
...
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBGetR(uint32_t rgb)
{
    return (rgb & 0xFF0000) >> 16;
}

/*fa MTR_ColorRGBGetG yes */
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBGetG(uint32_t rgb)
{
    return (rgb & 0x00FF00) >> 8;
}

/*fa MTR_ColorRGBGetB yes */
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBGetB(uint32_t rgb)
{
    return (rgb & 0x0000FF);
}

/*fa MTR_ColorRGBSetR yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBSetR(uint32_t rgb, uint8_t r)
{
    return (rgb & 0x00FFFF) | (r << 16);
}

/*fa MTR_ColorRGBSetG yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBSetG(uint32_t rgb, uint8_t g)
{
    return (rgb & 0xFF00FF) | (g << 8);
}

/*fa MTR_ColorRGBSetB yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBSetB(uint32_t rgb, uint8_t b)
{
    return (rgb & 0xFFFF00) | b;
}

/*fa MTR_ColorSplitRGBA yes */
MTR_DCLSPC void MTR_CALL MTR_ColorSplitRGBA(uint32_t rgba, uint8_t *r,
...
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBAGetR(uint32_t rgba)
{
    return (rgba & 0xFF000000) >> 24;
}

/*fa MTR_ColorRGBAGetG yes */
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBAGetG(uint32_t rgba)
{
    return (rgba & 0x00FF0000) >> 16;
}

/*fa MTR_ColorRGBAGetB yes */
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBAGetB(uint32_t rgba)
{
    return (rgba & 0x0000FF00) >> 8;
}

/*fa MTR_ColorRGBAGetA yes */
MTR_DCLSPC uint8_t MTR_CALL MTR_ColorRGBAGetA(uint32_t rgba)
{
    return (rgba & 0x00000FF);
}

/*fa MTR_ColorRGBASetR yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBASetR(uint32_t rgba, uint8_t r)
{
    return (rgba & 0x00FFFFFF) | (r << 24);
}

/*fa MTR_ColorRGBASetG yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBASetG(uint32_t rgba, uint8_t g)
{
    return (rgba & 0xFF00FFFF) | (g << 16);
}

/*fa MTR_ColorRGBASetB yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBASetB(uint32_t rgba, uint8_t b)
{
    return (rgba & 0xFFFF00FF) | (b << 8);
}

/*fa MTR_ColorRGBASetA yes */
MTR_DCLSPC uint32_t MTR_CALL MTR_ColorRGBASetA(uint32_t rgba, uint8_t a)
{
