...
typedef void (MTR_CALL * mtrPrimitiveLine_rgba_fFunc)(float, float, float,
...
typedef void (MTR_CALL * mtrPrimitiveSegmentFilled_c_fFunc)(float, float, float,
 float, float, uint32_t);
mtrPrimitiveSegmentFilled_c_fFunc mtrPrimitiveSegmentFilled_c_f;

typedef void (MTR_CALL * mtrPrimitiveSegmentFilled_ca_fFunc)(float, float,
...
/* CircleFilled */
typedef void (MTR_CALL * mtrPrimitiveCircleFilled_rgb_fFunc)(float, float,
 float, uint8_t, uint8_t, uint8_t);
...
typedef void (MTR_CALL * mtrPrimitiveEllipseFilled_ca_fFunc)(float, float,
 float, float, float, uint32_t);
mtrPrimitiveEllipseFilled_ca_fFunc mtrPrimitiveEllipseFilled_ca_f;

/* RingSegment */
typedef void (MTR_CALL * mtrPrimitiveRingSegment_rgb_fFunc)(float, float, float,
 float, float, float, uint8_t, uint8_t, uint8_t);
