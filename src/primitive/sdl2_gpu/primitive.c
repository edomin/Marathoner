...
MTR_EXPORT void MTR_CALL MTR_PrimitiveFill_rgb(uint8_t r, uint8_t g, uint8_t b)
{
...
MTR_EXPORT void MTR_CALL MTR_PrimitiveFill_rgba(uint8_t r, uint8_t g, uint8_t b,
 uint8_t a)
{
    MTR_PRIMITIVE_CHECK_IF_NOT_INITED();
...
MTR_EXPORT void MTR_CALL MTR_PrimitiveLineTo_rgb_f(float x, float y, uint8_t r,
 uint8_t g, uint8_t b)
{
    SDL_Color sdl_color;
    MTR_PRIMITIVE_CHECK_IF_NOT_INITED();
...
MTR_EXPORT void MTR_CALL MTR_PrimitiveLineTo_rgba_f(float x, float y, uint8_t r,
 uint8_t g, uint8_t b, uint8_t a)
{
    SDL_Color sdl_color;
    MTR_PRIMITIVE_CHECK_IF_NOT_INITED();
