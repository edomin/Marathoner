...
typedef void (MRT_CALL * mtrPrimitiveLine_rgba_fFunc)(float, float, float, float,
...
typedef void (MRT_CALL * mtrPrimitiveSegmentFilled_c_fFunc)(float, float,
 float, float, float, uint32_t);
mtrPrimitiveSegmentFilled_c_fFunc mtrPrimitiveSegmentFilled_c_f;

typedef void (MRT_CALL * mtrPrimitiveSegmentFilled_ca_fFunc)(float, float, float,
...
/* CircleFilled */
typedef void (MRT_CALL * mtrPrimitiveCircleFilled_rgb_fFunc)(float, float, float,
 uint8_t, uint8_t, uint8_t);
...
typedef void (MRT_CALL * mtrPrimitiveEllipseFilled_ca_fFunc)(float, float, float,
 float, float, uint32_t);
mtrPrimitiveEllipseFilled_ca_fFunc mtrPrimitiveEllipseFilled_ca_f;

/* RingSegment */
typedef void (MRT_CALL * mtrPrimitiveRingSegment_rgb_fFunc)(float, float,
