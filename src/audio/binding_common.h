...
MTR_FUNC(bool, MTR_AudioMusicPlaying, uint32_t);
MTR_FUNC(bool, MTR_AudioMusicFadingIn, void);
MTR_FUNC(bool, MTR_AudioMusicFadingOut, void);
MTR_FUNC(void, MTR_AudioMusicPlay, uint32_t, int);
