...
MTR_EXPORT void MTR_CALL mtrPluginInit(void)
{
    ...
    else
    {
        ...
        mtrTextureInit = (mtrTextureInitFunc)mtrFindFunction("Texture_SDL2_image",
          "mtrTextureInit");
        ...
        mtrTextureBeginTarget = (mtrTextureBeginTargetFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureEndTarget = (mtrTextureEndTargetFunc)mtrFindFunction("Texture_SDL2_image",
          "mtrTextureEndTarget");
        ...
        mtrTextureCreate = (mtrTextureCreateFunc)mtrFindFunction("Texture_SDL2_image",
          "mtrTextureCreate");
        ...
        mtrTextureLoad = (mtrTextureLoadFunc)mtrFindFunction("Texture_SDL2_image",
          "mtrTextureLoad");
        ...
        mtrTextureFree = (mtrTextureFreeFunc)mtrFindFunction("Texture_SDL2_image",
          "mtrTextureFree");
        ...
        mtrTextureSetBlendFunction = (mtrTextureSetBlendFunctionFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureSetAlphaBlending = (mtrTextureSetAlphaBlendingFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureBlit_f = (mtrTextureBlit_fFunc)mtrFindFunction("Texture_SDL2_image",
          "mtrTextureBlit_f");
        ...
        mtrTextureBlitRegion_f = (mtrTextureBlitRegion_fFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureBlitRegionScaled_f = (mtrTextureBlitRegionScaled_fFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureBlitRegionAngled_f = (mtrTextureBlitRegionAngled_fFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureBlitRegionFlipped_f = (mtrTextureBlitRegionFlipped_fFunc)mtrFindFunction("Texture_SDL2_image",
        ...
        mtrTextureBlitRegionGeneral_f = (mtrTextureBlitRegionGeneral_fFunc)mtrFindFunction("Texture_SDL2_image",
