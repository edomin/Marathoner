...
win32: prebuild
	...
	make -C src/$(SCREEN_SDL2_GPU_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(SCREEN_SDL2_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(TEXTURE_SDL2_GPU_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(TEXTURE_SDL2_IMAGE_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(PRIMITIVE_SDL2_GPU_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(PRIMITIVE_SDL2_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(PRIMITIVE_SDL2_GFX_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(TTF_SDL2_TTF_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(AUDIO_SDL2_MIXER_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(ABSTRACTION_SPRITE_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(ABSTRACTION_FONT_DUKTAPE) PREFIX=$(PREFIX)
	...
	make -C src/$(ABSTRACTION_GUI_DUKTAPE) PREFIX=$(PREFIX)
